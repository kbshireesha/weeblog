      ...
      <header>
        <nav class="navbar">
          ...
          <div class="navbar-nav">
            <button class="nav-item" :class="{ active: activeTab === 'home' }"  @click="goHome" >
              Home
            </button>
            <button class="nav-item" :class="{ active: activeTab === 'create' }" @click="openCreateModal">
              Add Blog
            </button>
          </div>
        </nav>
...
import { getPosts, updatePost, deletePost as deletePostService } from '@/services/BlogService.js';
import { useRouter } from 'vue-router';
import ModalForm from './BlogFormComponent.vue';
